	...
	return (
		<div className="rounded-[20px] bg-bg-second p-5">
			<div className="relative aspect-square rounded-[20px] bg-gray-2 text-sm font-semibold">
				...
				<div className="absolute bottom-2 left-1/2 flex -translate-x-1/2 items-center gap-2 rounded-full bg-background py-1.5 px-3 leading-none">
					<FireIcon />
					05 : 12 : 07 : 45
				</div>
			</div>
		...
		<section className="py-10">
			<div className="container">
				<div className="flex items-center justify-between">
					<h4 className="text-4xl font-bold">Live Auctions</h4>
